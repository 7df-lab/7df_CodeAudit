...
| D2 | `services/gateway-service/README.md` 等历史文档路由表/端口/中间件序/TTL 多处过时（宣称 /v1/results、/v1/storage 域、task PUT/DELETE、50053/50054 端口、per-IP 限流） | 以本文 §2 为准 | 三份历史文档不再维护路由事实；新文档即 SSOT |
